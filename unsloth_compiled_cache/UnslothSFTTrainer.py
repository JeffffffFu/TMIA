...
class UnslothSFTConfig(SFTConfig):
    ...
    Parameters:
        ...
        padding_free (`bool`, *optional*, defaults to `False`):
            ...
            training sequence. This reduces memory usage by eliminating padding overhead. Currently, this is only
...
class _UnslothSFTTrainer(Trainer):
    ...
    def __init__(
        ...
        # In Prompt Tuning a small set of trainable virtual tokens [training prompt embeddings] is prepended to the
